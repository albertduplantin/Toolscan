...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default: 'liquid-button text-white shadow-lg hover:shadow-xl',
        destructive:
          'bg-gradient-to-r from-red-500 to-pink-500 text-white shadow-lg hover:shadow-xl hover:scale-105',
        outline:
          'border-2 border-primary/20 bg-white/40 backdrop-blur-sm hover:bg-white/60 hover:border-primary/40 shadow-md',
        secondary:
          'bg-white/50 backdrop-blur-sm text-secondary-foreground hover:bg-white/70 shadow-md hover:shadow-lg',
        ghost: 'hover:bg-white/30 backdrop-blur-sm hover:shadow-md',
